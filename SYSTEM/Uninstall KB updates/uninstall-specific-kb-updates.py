...
if not kb_list_user and len(kb_list)!=0:
    ...
    if match:
        ...
        for i in range(0,len(match)):
            fin=ecmd('DISM.exe /Online /Remove-Package /PackageName:Package_for_KB%s /quiet /norestart'%match[i],False)
        ...
        print '\n None of the kb values specified are not Matched with installed updates\n' 
